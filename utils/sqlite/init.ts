  ...
  try {
    ...
    if (currentDbVersion === 2) {
      await db.execAsync(`
        ...
        INSERT INTO messages_new (id, conversation_id, role, content, created, is_deleted, deleted)
        SELECT id, conversation_id, role, content, created, is_deleted, deleted FROM messages;
